...
// *** platforms that support hardware based Serial2. On
...
//if battery is less than 2.6V, set a flag
void checkBattery() {

  //Serial2.print("Battery Voltage: ");
  //Serial2.println(getBatteryVoltage());
...
void getBackgroundAverage() {
  ...
  //Serial2.print("Background average: ");
